...
public class UIMesh : MonoBehaviour
{
	...
	public void DoLateUpdate()
	{
		...
		{
			TSprite tSprite = (TSprite)m_Sprites[i];
			if (!(tSprite.Material == null))
			{
				...
				else if (((TSprite)arrayList[0]).Material != tSprite.Material)
				{
					arrayList = new ArrayList();
					m_DrawGroups.Add(arrayList);
					arrayList.Add(tSprite);
		...
		for (int j = 0; j < m_DrawGroups.Count; j++)
		{
			...
			Material material = ((TSprite)arrayList2[0]).Material;
			array4[num3] = new int[arrayList2.Count * 6];
			for (int k = 0; k < arrayList2.Count; k++)
			{
				TSprite tSprite2 = (TSprite)arrayList2[k];
				array[num2] = tSprite2.Vertices[0];
				array[num2 + 1] = tSprite2.Vertices[1];
				array[num2 + 2] = tSprite2.Vertices[2];
				array[num2 + 3] = tSprite2.Vertices[3];
				array2[num2] = tSprite2.UV[0];
				array2[num2 + 1] = tSprite2.UV[1];
				array2[num2 + 2] = tSprite2.UV[2];
				array2[num2 + 3] = tSprite2.UV[3];
				array3[num2] = tSprite2.Color;
				array3[num2 + 1] = tSprite2.Color;
				array3[num2 + 2] = tSprite2.Color;
				array3[num2 + 3] = tSprite2.Color;
				int num4 = k * 6;
				array4[num3][num4] = num2 + TSprite.Triangles[0];
				array4[num3][num4 + 1] = num2 + TSprite.Triangles[1];
				array4[num3][num4 + 2] = num2 + TSprite.Triangles[2];
				array4[num3][num4 + 3] = num2 + TSprite.Triangles[3];
				array4[num3][num4 + 4] = num2 + TSprite.Triangles[4];
				array4[num3][num4 + 5] = num2 + TSprite.Triangles[5];
				num2 += 4;
			}
