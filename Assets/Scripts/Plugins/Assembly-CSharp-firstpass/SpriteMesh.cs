...
public class SpriteMesh : MonoBehaviour
{
	...
	public void LateUpdate()
	{
		...
		{
			TSprite tSprite = (TSprite)m_Sprites[j];
			int layer = tSprite.Layer;
			if (layer < 0 || layer >= m_MaxSpriteLayer)
			{
				continue;
			}
			Material material = tSprite.Material;
			if (!(material == null))
			{
				num++;
				if (m_SpritesGroup[layer].Contains(material))
				{
					...
					arrayList.Add(tSprite);
				}
				else
				{
					ArrayList arrayList2 = new ArrayList();
					arrayList2.Add(tSprite);
		...
		for (int l = 0; l < m_MaxSpriteLayer; l++)
		{
			...
			foreach (Material material2 in array6)
			{
				...
				{
					TSprite tSprite2 = (TSprite)arrayList3[n];
					array[num3] = tSprite2.Vertices[0];
					array[num3 + 1] = tSprite2.Vertices[1];
					array[num3 + 2] = tSprite2.Vertices[2];
					array[num3 + 3] = tSprite2.Vertices[3];
					array2[num3] = tSprite2.UV[0];
					array2[num3 + 1] = tSprite2.UV[1];
					array2[num3 + 2] = tSprite2.UV[2];
					array2[num3 + 3] = tSprite2.UV[3];
					array3[num3] = tSprite2.Color;
					array3[num3 + 1] = tSprite2.Color;
					array3[num3 + 2] = tSprite2.Color;
					array3[num3 + 3] = tSprite2.Color;
					int num5 = n * 6;
					array4[num4][num5] = num3 + TSprite.Triangles[0];
					array4[num4][num5 + 1] = num3 + TSprite.Triangles[1];
					array4[num4][num5 + 2] = num3 + TSprite.Triangles[2];
					array4[num4][num5 + 3] = num3 + TSprite.Triangles[3];
					array4[num4][num5 + 4] = num3 + TSprite.Triangles[4];
					array4[num4][num5 + 5] = num3 + TSprite.Triangles[5];
					num3 += 4;
				}
	...
	public void Add(TSprite sprite)
	{
		m_Sprites.Add(sprite);
	}

	public void Remove(TSprite sprite)
	{
